...
- 不同状态的占领点样式
  ...
  - 中立点位：灰色：
    ...
    ![image.png](https://image.baidu.com/search/down?url=https://fc.sinaimg.cn/large/00724HnBly1hisgrsg91vj31hc0rmb29.jpg)点位进度条：根据不同队伍触发的`captureTime`，展示进度条，绕占领点底一周展示。
